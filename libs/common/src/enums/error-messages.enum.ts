...
export enum OrderErrors {
  ...
  INVALID_EMAIL_ERR = 'INVALID_EMAIL_ERR',
  EMAIL_REQUIRED_ERR = 'EMAIL_REQUIRED_ERR',
  ORDER_NOT_FOUND_ERR = 'ORDER_NOT_FOUND_ERR',
}
...
export enum PaymentErrors {
  ...
  PAYMENT_NOT_FOUND_ERR = 'PAYMENT_NOT_FOUND_ERR',
}

export enum MessagesErrors {
  MESSAGE_NOT_FOUND_ERR = 'MESSAGE_NOT_FOUND_ERR',
}

export enum SettingsErrors {
  ADDRESS_NOT_FOUND_ERR = 'ADDRESS_NOT_FOUND_ERR',
  BANK_DETAILS_NOT_FOUND_ERR = 'BANK_DETAILS_NOT_FOUND_ERR',
}
